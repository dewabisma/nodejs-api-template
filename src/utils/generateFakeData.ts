...
import type { User } from '@/modules/users/interfaces/User.js';
import { UserRole, UserStatus } from '@/modules/models.js';
import type { Promotion } from '@/modules/promotions/interfaces/Promotion.js';
